...
namespace MRK.MAUI.RefactorKit
{
	...
	public class MRKAnalyzerDelegateCommand : DiagnosticAnalyzer
	{
		...
		static readonly LocalizableString Title = new LocalizableResourceString(nameof(Resources.DelegateCommandAnalyzerTitle), Resources.ResourceManager, typeof(Resources));
		static readonly LocalizableString MessageFormat = new LocalizableResourceString(nameof(Resources.DelegateCommandAnalyzerMessageFormat), Resources.ResourceManager, typeof(Resources));
		static readonly LocalizableString Description = new LocalizableResourceString(nameof(Resources.DelegateCommandAnalyzerDescription), Resources.ResourceManager, typeof(Resources));
